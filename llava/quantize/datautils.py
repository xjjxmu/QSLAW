...
def get_wikitext2(nsamples, seed, seqlen, model):
    print("get_wikitext2")
    traindata = load_dataset('/data/zyx/llava/cache/wikitext', 'wikitext-2-raw-v1', split='train')
    testdata = load_dataset('/data/zyx/llava/cache/wikitext', 'wikitext-2-raw-v1', split='test')
