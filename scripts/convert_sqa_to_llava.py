    ...
    for prob_id, (input, output) in split_problems.items():
        ...
        if raw_prob_data['image'] is None:
            target_format.append({
                ...
                "grade":problems[prob_id]["grade"],
                "subject": problems[prob_id]["subject"],
                "no_context": True if (not problems[prob_id]['hint'] and not problems[prob_id]['image']) else False,
                "has_text": True if problems[prob_id]['hint'] else False,
                "has_image": False,
                "has_text_image": True if (problems[prob_id]['hint'] and problems[prob_id]['image']) else False,
            })
